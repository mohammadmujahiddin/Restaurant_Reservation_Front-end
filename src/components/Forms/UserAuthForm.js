...
const LoginForm = () => {
  ...
  const validationLoginForm = Yup.object().shape({
    phoneLogin: Yup.string().phone('IN', true, 'Phone number is invalid') // Change 'US' to 'IN'
      .required(),
  ...
  const validationRegisterForm = Yup.object().shape({
    ...
    lastName: Yup.string()
      ...
      phoneRegister: Yup.string().phone('IN', true, 'Phone number is invalid') // Change 'US' to 'IN'
      .required(),
                  ...
                  render={({ field }) => (
                    <>
                      ...
                      <MuiTelInput
                        style={{ display: 'none' }}
                        {...field}
                        value="" // Reset the value to prevent conflicts
                      />
                    </>
                  )}
                />
